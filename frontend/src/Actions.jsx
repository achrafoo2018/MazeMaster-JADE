...
const Actions = ({ speed, setSpeed, setGameStarted, setMatrix, setAgentPaths }) => {
    ...
    try {
      ...
      setAgentPaths({
        bfs: {
          ...
          , image: hamma, color: 'blue', msgs: [] // el mesgs bta3 el bfs fel response bte3ek
          , res: [] // el messages bta3 el agent master coodinater lel aget bfs
        },
        dfs: {
          path: [] // same
          , image: chroufa, color: 'green', msgs: [], // same,
          res: [] // same
        },
        astar: {
          path: [] // same
          , image: slouma, color: 'red', msgs: [], // same,
          res: [] // same
        }
      })
    } catch (error) {
      ...
      <div className="flex flex-column gap-6 ">
        ...
        <div>
          ...
          <div className="card flex flex-wrap align-items-center justify-content-center gap-3">
            ...
            }} icon="pi pi-refresh" size="large" className="p-2"><span className="ml-2">Shuffle</span></Button>
